    ...
    return (
      ...
      >
        <div className="flex items-center justify-between">
          <p className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">Reguła</p>
          <button
            type="button"
    ...
    <div className="space-y-3">
      <div className="p-3 rounded-md border border-primary/20 bg-primary/5">
        <p className="text-xs text-muted-foreground">
          Buduj warunki jako drzewo reguł. Każda grupa może używać operatora <b>AND</b> lub <b>OR</b>.
        </p>
      </div>
